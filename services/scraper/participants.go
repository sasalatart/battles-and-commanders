...
func (s *Scraper) subscribeParticipants(c *colly.Collector, b *domain.SBattle) {
...
func (s *Scraper) subscribeFactions(c *colly.Collector, b *domain.SBattle, fm factionsMapper) {
...
func (s *Scraper) subscribeCommanders(c *colly.Collector, b *domain.SBattle, cm commandersMapper) {
...
func (s *Scraper) participantsSide(e *colly.HTMLElement, kind domain.ParticipantKind, sideSelector string, onDone onParticipantDone) {
	...
	e.ForEach(fullSelector, func(_ int, side *colly.HTMLElement) {
		side.ForEach("a", func(_ int, node *colly.HTMLElement) {
			...
			summary, err := summaries.Get(pURL)
			if err != nil {
...
func subscribeGroupings(c *colly.Collector, b *domain.SBattle, factionsByFlag map[string]int, commandersByFlag map[string][]int) {
