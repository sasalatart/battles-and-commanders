...
func Scrape(l logger.Service) []domain.SBattleItem {
	hrefs := make(hrefsCache)
	var items []domain.SBattleItem
...
func do(url string, battlesItems *[]domain.SBattleItem, hrefs hrefsCache, l logger.Service) error {
	...
	c.OnHTML(listItemsSelector, func(e *colly.HTMLElement) {
		...
		hrefs[href] = struct{}{}
		*battlesItems = append(*battlesItems, domain.SBattleItem{
