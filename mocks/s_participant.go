...
func SFaction(overrides domain.SParticipant) (domain.SParticipant, error) {
	mock := domain.SParticipant{
...
// SCommander returns a commander instance of domain.SParticipant that may be used for testing
// purposes. Some values may be overriden by the input commander.
func SCommander(overrides domain.SParticipant) (domain.SParticipant, error) {
	mock := domain.SParticipant{
